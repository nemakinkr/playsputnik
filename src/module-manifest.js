...
(function (root) {
  const modules = [
    ...
    [3, "src/app-account.js", "PlaySputnikAccount", "Account capability and private profile transport"],
    ...
    [4, "src/app-activity.js", "PlaySputnikActivity", "Recent changes and weekly companion report"],
