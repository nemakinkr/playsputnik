...
const CASES = [
  ...
  { id: "alias-rdr1", query: "Red Dead 1", expectedTop: "Red Dead Redemption", sourceId: "seed_catalog", matchKind: "exact" },
  { id: "ru-cyberpunk", query: "Киберпанк 2077", expectedTop: "Cyberpunk 2077", sourceId: "seed_catalog", matchKind: "exact" },
  { id: "alias-kcd1", query: "KCD", expectedTop: "Kingdom Come: Deliverance", sourceId: "seed_catalog", matchKind: "exact" },
  { id: "ru-metro-exodus", query: "Метро Исход", expectedTop: "Metro Exodus", sourceId: "catalog_backbone", matchKind: "exact" },
  { id: "alias-wolfenstein-2", query: "Wolfenstein 2", expectedTop: "Wolfenstein II: The New Colossus", sourceId: "seed_catalog", matchKind: "exact" },
  { id: "alias-abzu", query: "Abzu", expectedTop: "ABZU", sourceId: "seed_catalog", matchKind: "exact" },
  { id: "alias-kena", query: "Кена", expectedTop: "Kena: Bridge of Spirits", sourceId: "seed_catalog", matchKind: "exact" },
  { id: "fixture-council", query: "The Council", expectedTop: "The Council", sourceId: "prototype_external_index", matchKind: "exact" },
  { id: "fixture-firewatch", query: "Firewatch", expectedTop: "Firewatch", sourceId: "prototype_external_index", matchKind: "exact" },
  { id: "fixture-man-of-medan", query: "Man of Medan", expectedTop: "The Dark Pictures Anthology: Man of Medan", sourceId: "prototype_external_index", matchKind: "exact" },
  { id: "fixture-cult-lamb", query: "Cult of the Lamb", expectedTop: "Cult of the Lamb", sourceId: "prototype_external_index", matchKind: "exact" },
  { id: "fixture-sword-sea", query: "Sword of the Sea", expectedTop: "Sword of the Sea", sourceId: "prototype_external_index", matchKind: "exact" },
  { id: "fixture-killer-frequency", query: "Killer Frequency", expectedTop: "Killer Frequency", sourceId: "prototype_external_index", matchKind: "exact" },
  { id: "fixture-lego-horizon", query: "LEGO Horizon Adventures", expectedTop: "LEGO Horizon Adventures", sourceId: "prototype_external_index", matchKind: "exact" },
  { id: "fixture-murdered", query: "Murdered Soul Suspect", expectedTop: "Murdered: Soul Suspect", sourceId: "prototype_external_index", matchKind: "exact" },
  { id: "fixture-fortnite", query: "Fortnite", expectedTop: "Fortnite", sourceId: "prototype_external_index", matchKind: "exact" },
  { id: "fixture-zelda-botw", query: "The Legend of Zelda Breath of the Wild", expectedTop: "The Legend of Zelda: Breath of the Wild", sourceId: "prototype_external_index", matchKind: "exact" },
  { id: "fixture-sims-4", query: "The Sims 4", expectedTop: "The Sims 4", sourceId: "prototype_external_index", matchKind: "exact" },
  { id: "fixture-factorio", query: "Factorio", expectedTop: "Factorio", sourceId: "prototype_external_index", matchKind: "exact" },
  { id: "alias-cs2", query: "CS2", expectedTop: "Counter-Strike 2", sourceId: "prototype_external_index", matchKind: "exact" },
  { id: "alias-lol", query: "LoL", expectedTop: "League of Legends", sourceId: "prototype_external_index", matchKind: "exact" },
  { id: "alias-dota", query: "DOTA2", expectedTop: "Dota 2", sourceId: "prototype_external_index", matchKind: "exact" },
  { id: "alias-valo", query: "Valo", expectedTop: "Valorant", sourceId: "prototype_external_index", matchKind: "exact" },
  { id: "alias-botw", query: "BOTW", expectedTop: "The Legend of Zelda: Breath of the Wild", sourceId: "prototype_external_index", matchKind: "exact" },
  { id: "alias-totk", query: "TOTK", expectedTop: "The Legend of Zelda: Tears of the Kingdom", sourceId: "prototype_external_index", matchKind: "exact" },
  { id: "alias-r6-siege", query: "R6 Siege", expectedTop: "Tom Clancy’s Rainbow Six Siege", sourceId: "prototype_external_index", matchKind: "exact" },
  { id: "alias-r6s", query: "R6S", expectedTop: "Tom Clancy’s Rainbow Six Siege", sourceId: "prototype_external_index", matchKind: "exact" },
  { id: "alias-sims", query: "Sims", expectedTop: "The Sims 4", sourceId: "prototype_external_index", matchKind: "exact" },
  { id: "alias-acnh", query: "ACNH", expectedTop: "Animal Crossing: New Horizons", sourceId: "prototype_external_index", matchKind: "exact" },
  { id: "alias-fh5", query: "FH5", expectedTop: "Forza Horizon 5", sourceId: "prototype_external_index", matchKind: "exact" },
  { id: "alias-jedi-fallen-order", query: "Jedi Fallen Order", expectedTop: "Star Wars Jedi: Fallen Order", sourceId: "prototype_external_index", matchKind: "exact" },
